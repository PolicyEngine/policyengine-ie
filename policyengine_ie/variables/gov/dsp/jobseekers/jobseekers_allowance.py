...
class jobseekers_allowance(Variable):
    ...
    def formula(person, period, parameters):
        ...
        is_genuinely_seeking_work = person("is_genuinely_seeking_work", period, options=[True])
        ...
        is_living_independently = person("is_living_independently", period, options=[False])
        ...
        weekly_payment = personal_rate + qualified_adult_increase + qualified_child_increase
