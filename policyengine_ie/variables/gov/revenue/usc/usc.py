...
class usc(Variable):
    ...
    def formula(person, period, parameters):
        ...
        band_1_rate = where(eligible_for_reduced_rates, p.rates.reduced_band_1, p.rates.band_1)
        band_1_usc = band_1_income * band_1_rate
        
        # Band 2: €12,012.01 to €25,760
        band_2_income = max_(0, min_(gross_income - band_1_threshold, band_2_threshold - band_1_threshold))
        band_2_rate = where(eligible_for_reduced_rates, p.rates.reduced_band_2, p.rates.band_2)
        band_2_usc = band_2_income * band_2_rate
        
        # Band 3: €25,760.01 to €70,044
        band_3_income = max_(0, min_(gross_income - band_2_threshold, band_3_threshold - band_2_threshold))
        band_3_rate = where(eligible_for_reduced_rates, p.rates.reduced_band_3, p.rates.band_3)
